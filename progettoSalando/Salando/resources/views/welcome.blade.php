              ...
              <div class="d-flex justify-content-center">
                  <div class="row">
                      @foreach ($data as $data1)
                          <div class="col-lg-3 mb-3x p-3 flex-1">
                              <div class="card h-100 shadow border-0">
                                  <img class="card-img-top" src="https://dummyimage.com/600x350/ced4da/6c757d"
                                      alt="..." />
                                  <div class="card-body p-4">
                                      <div class="badge bg-primary bg-gradient rounded-pill mb-2">In saldo</div>
                                      <a class="text-decoration-none link-dark stretched-link" href="#!">
                                          <h5 class="card-title mb-3">{{ $data1['title'] }}</h5>
                                      </a>
                                      <p class="card-text mb-0">{{ $data1['description'] }}</p>
                                  </div>
                                  <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
                                      <div class="d-flex align-items-end justify-content-between">
                                          <div class="d-flex align-items-center">
                                              ...
                                              <div class="small">
                                                  <div class="fw-bold">{{ $data1['price'] }}$</div>
                                                  <div class="text-muted">Quantità : {{ $data1['category'] }}</div>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
