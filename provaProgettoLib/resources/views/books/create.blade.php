                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" required id="anno" name="year"
                                        value="{{ old('year') }}" type="text" placeholder="Anno produzione" />
                                    <label for="pages">Anno produzione</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input class="form-control" required id="pages" name="pages"
                                        value="{{ old('pages') }}" type="text" placeholder="Numero Pagine" />
                                ...
                                @foreach ($categories as $category )
                                    <input type="checkbox" class="form-check-input" value="{{$category->id}}" id="category_id" name="categories[]">
